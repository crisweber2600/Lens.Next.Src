...
# dependencies = []
# ///
"""Merge Bottom-Up LENS module help entries into shared BMad module-help.csv."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Merge Bottom-Up LENS help entries into _bmad/module-help.csv.")
