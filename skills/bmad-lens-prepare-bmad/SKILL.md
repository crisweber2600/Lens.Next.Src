---
name: bmad-lens-prepare-bmad
description: Prepare a focused BMAD packet for the active slice with scope, exclusions, decisions, risks, and acceptance evidence.
---
...
Feeds BMAD planning and solutioning with only the context needed for the active slice, not the whole messy system.
...
1. Read the active slice and optional outcome, journey, and capability context.
2. Include only required context, decisions, risks, acceptance evidence, and explicit exclusions.
3. Write markdown and yaml packet forms.
4. Recommend next BMAD product brief, PRFAQ, PRD, UX, architecture, epics, or readiness skill.
