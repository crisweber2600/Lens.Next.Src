...
REQUIRED_TEMPLATES = ['slice.yaml','discovery-epoch.yaml','relationship.yaml','promotion-gate.yaml','impact-map.yaml','bmad-packet.md','context-sufficiency.md','story-guard.yaml','salmon-signal.yaml','validation-result.yaml','doctor-report.md','auspex-status.yaml']
...
def main() -> int:
    ...
    elif 'code: lens' not in module_yaml.read_text(encoding='utf-8'):
