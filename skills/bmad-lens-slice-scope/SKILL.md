---
name: bmad-lens-slice-scope
description: Tighten a slice scope by separating required work, explicit exclusions, risks, and acceptance evidence.
---
...
Guards a slice against scope expansion before it becomes a BMAD packet or story input.
...
1. Review current includes and excludes.
2. Move speculative or adjacent work to exclusions.
3. Ensure acceptance evidence proves only this slice.
4. Record scope decisions and open questions.
