...
4. Use `bmad-create-architecture` to produce `architecture.md`.
5. Run `bmad-review-adversarial-general` against architecture, PRD/UX context, related ledgers, and Salmon risks; write `techplan-adversarial-review.md`.
