---
name: bmad-lens-detect-adjacency
description: Detect weak or strong adjacency between slices through shared artifacts, workflow, risks, or dependencies.
---
...
Creates adjacency records without promoting slices into capabilities until repeated pressure exists.
...
1. Compare slice artifacts, decisions, dependencies, users, risks, and workstream impact.
2. Classify adjacency strength and reason.
3. Recommend keep independent, monitor, split, or prepare promotion review.
4. Record provenance and confidence.
