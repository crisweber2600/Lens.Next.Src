---
name: bmad-lens-detect-repetition
description: Detect repeated pressure across slices, artifacts, risks, workflows, dependencies, and ownership concerns.
---
...
Turns repeated evidence into a pressure report that may support a human-reviewed promotion candidate.
...
1. Scan archive, slices, validation results, and implementation evidence.
2. Count repeated artifacts, workflows, risks, dependencies, and friction.
3. Separate true repeated pressure from model-imagined structure.
4. Recommend no action, monitor, or review promotion.
