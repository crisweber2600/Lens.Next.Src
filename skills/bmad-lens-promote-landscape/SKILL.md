---
name: bmad-lens-promote-landscape
description: Promote reviewed entities and relationships into the Living Landscape without rewriting archive history.
---
...
Updates current truth ledgers from reviewed evidence while preserving raw archive records.
...
1. Read promotion gates or reviewed concepts.
2. Confirm human review status.
3. Update the smallest relevant landscape ledger.
4. Supersede stale landscape entries instead of deleting history.
5. Queue map rebuild.
...
landscape ledger updates and promotion decision.
