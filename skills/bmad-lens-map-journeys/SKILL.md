---
name: bmad-lens-map-journeys
description: Map end-to-end journeys across roles, data, decisions, system surfaces, and success evidence.
---
...
Transforms outcomes into journey ledgers and journey maps that later produce vertical slices.
...
1. Choose a focused outcome and role.
2. Map start, steps, data movement, decisions, state changes, and success evidence.
3. Record unknowns and risks.
4. Avoid designing the whole product when only one journey is ready.
...
journey.yaml, journey.md, journey-map.mmd.
