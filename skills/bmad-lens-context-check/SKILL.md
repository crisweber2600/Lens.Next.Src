---
name: bmad-lens-context-check
description: Assess whether context is sufficient for PRD, architecture, or BMAD planning and block premature PRD creation.
---
...
Creates a context sufficiency gate across thesis, roles, outcomes, loops, journeys, slice readiness, architecture readiness, and PRD readiness.
...
1. Score readiness dimensions.
2. List open questions, unresolved decisions, high-severity risks, research gaps, and unchallenged assumptions.
3. State whether PRD is ready, not ready, or blocked.
4. Recommend the next discovery, review, or research step.
...
context sufficiency report and context-score.yaml.
