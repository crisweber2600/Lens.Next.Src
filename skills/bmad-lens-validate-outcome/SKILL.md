---
name: bmad-lens-validate-outcome
description: Validate whether slices and journeys satisfy the intended outcome evidence rather than only shipping features.
---
...
Checks outcome-level evidence and separates implementation completion from validated user or stakeholder value.
...
1. Read outcome, journey validation, slice validation, stakeholder evidence, and tests.
2. Assess whether evidence supports the outcome.
3. Mark outcome validated, partial, not validated, blocked, or stale.
4. Recommend BMAD retrospective, correct-course, or more LENS discovery if needed.
