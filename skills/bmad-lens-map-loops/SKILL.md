---
name: bmad-lens-map-loops
description: Map operating loops that explain repeated system behavior, evidence movement, decisions, and state changes.
---
...
Creates operating loop hypotheses that can feed journey mapping and slice selection.
...
1. Identify repeated cycles of action, evidence, decision, and improvement.
2. Separate confirmed loops from hypotheses.
3. Link loops to roles, outcomes, journeys, risks, and open questions.
4. Use loops only where evidence supports them.
