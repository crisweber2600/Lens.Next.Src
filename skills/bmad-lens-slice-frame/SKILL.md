---
name: bmad-lens-slice-frame
description: Frame a candidate slice with goal, starts-with, ends-with, vertical path, evidence, and boundaries.
---
...
Turns a candidate slice into a buildable vertical frame while preserving optional system, journey, and capability links.
...
1. Confirm the slice goal and useful endpoint.
2. Identify start state and end state.
3. Map experience, data, policy, contracts, and tests along the vertical path.
4. Keep future adjacent work out of scope.
