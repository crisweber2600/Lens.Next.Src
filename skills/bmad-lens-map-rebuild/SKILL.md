---
name: bmad-lens-map-rebuild
description: Regenerate the Derived Map, relationship index, traceability index, freshness index, and warnings from source truth.
---
...
Rebuilds graph projections from archive and landscape metadata; the graph is never source truth.
...
2. Scan archive and landscape source files.
3. Generate derived-map.yaml, derived-map.json, relationship-index.yaml, traceability-index.yaml, freshness-index.yaml, and warnings.yaml.
4. Do not hand-edit graph outputs.
