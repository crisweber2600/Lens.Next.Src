---
name: bmad-lens-synthesize
description: Extract candidate roles, outcomes, journeys, artifacts, risks, assumptions, and relationships from raw material.
---
...
Moves material from raw capture into extracted or hypothesized concepts with confidence, provenance, and open questions.
...
1. Read raw capture records.
2. Extract candidate entities and relationships.
3. Mark every concept with status, confidence, source refs, and questions.
4. Identify contradictions and weak assumptions.
5. Recommend review, research, or context-check steps.
...
extraction yaml and extraction index update.
