---
name: bmad-lens-map-outcomes
description: Map role-specific outcomes and stakeholder value without jumping directly to features or PRD.
---
...
Builds outcome matrices with provenance, confidence, roles, evidence, risks, and relationships.
...
1. Identify roles and stakeholders.
2. State outcomes as changed user or stakeholder reality.
3. Link outcomes to source refs and risks.
4. Select or recommend one focused outcome when ready.
