---
name: bmad-lens-sync-bmad
description: Sync BMAD artifacts back into LENS traceability, relationships, implementation evidence, and landscape updates.
---
...
Reads BMAD planning and implementation artifacts and records traceability without treating BMAD output as automatically validated truth.
...
1. Locate BMAD artifacts in planning and implementation output folders.
2. Link PRD, UX, architecture, epics, stories, and reviews to slices and relationships.
3. Record evidence, stale links, and missing traceability.
4. Recommend guard-story, validation, Salmon, or map rebuild as needed.
...
BMAD sync report and evidence records.
