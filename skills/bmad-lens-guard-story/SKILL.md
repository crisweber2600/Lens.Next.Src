---
name: bmad-lens-guard-story
description: Check that a BMAD story traces to an active LENS slice and does not silently expand scope.
---
...
Guards story readiness across traceability, slice scope, acceptance evidence, risks, policy boundaries, and Salmon triggers.
...
1. Read the story and active slice or BMAD packet.
2. Verify traceability, scope, acceptance evidence, risk acknowledgement, privacy and policy boundaries, and packet references.
3. Flag untraceable or scope-expanding stories.
4. Recommend Salmon when implementation changes upstream assumptions.
