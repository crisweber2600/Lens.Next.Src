---
name: bmad-lens-slice-journey
description: Select thin vertical slices from a mapped journey using sequencing rationale and acceptance evidence.
---
...
Turns a large journey into a slice roadmap and the first focused vertical slice for BMAD packet preparation.
...
1. Read the journey and outcome.
2. Find the smallest useful vertical path that proves progress.
3. Document why-first sequencing rationale.
4. Create a slice record with explicit exclusions and acceptance evidence.
...
slice roadmap and selected slice.
