---
name: bmad-lens-capture
description: Capture sessions, notes, documents, screenshots, codebase hints, and BMAD artifacts without treating them as truth.
---
...
Adds raw source records to the Work Archive with provenance and source references.
...
1. Create a source record for the input.
2. Store raw content or a durable reference.
3. Label it raw with confidence low unless directly confirmed.
4. Do not promote captured material into landscape truth.
...
capture session and source records.
