---
name: bmad-lens-research-plan
description: Turn context gaps into focused BMAD domain, market, technical, adversarial, or elicitation research tasks.
---
...
Plans research without replacing BMAD research skills, and ties research questions back to LENS entities and gates.
...
1. Read context-check gaps.
2. Group unknowns by domain, market, technical, stakeholder, risk, or implementation evidence.
3. Recommend BMAD research or review skills.
4. Define expected evidence and where it will be stored.
