---
name: bmad-lens-map-system
description: Model a system thesis, roles, stakeholders, principles, constraints, assumptions, risks, and non-goals.
---
...
Creates or updates top-down system intent only from reviewed concepts and source references.
...
1. Review extracted concepts and human-reviewed facts.
2. Draft or update system thesis, roles, stakeholders, principles, constraints, and risks.
3. Mark uncertain parts as hypothesized.
4. Keep systems optional for bottom-up slices.
...
system thesis and intent ledgers.
