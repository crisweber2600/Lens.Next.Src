---
name: bmad-lens-analyze-impact
description: Create a slice impact map covering likely files, services, contracts, tests, workstreams, data, privacy, and decisions.
---
...
Finds codebase, artifact, contract, workstream, rollout, test, observability, and policy impact before BMAD implementation begins.
...
1. Read the active slice and repository context.
2. Identify direct and possible impacts.
3. List files, contracts, tests, feature flags, observability, data, privacy, and policy boundaries.
4. Recommend continue, dependency note, split, block, packet update, or BMAD correct-course.
