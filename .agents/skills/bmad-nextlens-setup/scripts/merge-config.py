...
# dependencies = ["pyyaml"]
# ///
"""Merge NextLens module configuration into shared BMad config files."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Merge module config into _bmad/config.yaml.")
